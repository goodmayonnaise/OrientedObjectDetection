...
class YOLOv11Backbone(BaseBackbone):
    ...
    arch_settings = {
        'P5': [[64, 256, 2, True, False, 0.25], [256, 512, 2, True, False, 0.25],
               [512, 512, 2, True, False, 0.5], [512, None, 2, True, True, 0.5]],
    }
    ...
    def build_stage_layer(self, stage_idx: int, setting: list) -> list:
        ...
        """
        in_channels, out_channels, num_blocks, add_identity, use_spp, expand_ratio = setting
