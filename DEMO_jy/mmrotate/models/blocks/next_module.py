...
from ..backbones.modules.RotatDeforConv import RotationallyDeformableConvolution
from mmengine.model import BaseModule
# from .new_module import RDCModule
###############################################################
...
class CSPDeformConvBlock(BaseModule):
    """The basic bottleneck block used in CSPNeXt.
...
class CSPLayer(nn.Module):
    ...
    def __init__(self,
        ...
        super().__init__()
        block = CSPNeXtBlock if use_cspnext_block else CSPDeformConvBlock
